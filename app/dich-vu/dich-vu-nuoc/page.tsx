...
export default function Home() {
    const slideItems = [
        ...
        },
        {
            ...
            label: "XỬ LÝ CHỐNG THẤM TƯỜNG, TRẦN, SÀN NHÀ",
            description: "Chuyên xử lý chống thấm cho tường, trần, sàn nhà triệt để bảo hành dài hạn"
        },
        {
            href: '/',
            src: '/assets/services/nuoc/nuoc-4.jpg',
            label: "LẮP ĐẶT ĐƯỜNG ỐNG NƯỚC",
            description: "Dịch vụ lắp đặt đường ống nước: lắp đặt các hệ thống cấp thoát nước, đường nước nóng, lạnh, đường nước âm tường, với chất lượng cao, đáp ứng mọi nhu cầu của gia đình và doanh nghiệp."
        },
        {
            href: '/',
            src: '/assets/services/nuoc/nuoc-9.jpg',
            label: "LẮP ĐẶT THIẾT BỊ VỆ SINH: BỒN CẦU, BỒN BỆT, LAVABO, VAN NƯỚC, VÒI NƯỚC,...",
