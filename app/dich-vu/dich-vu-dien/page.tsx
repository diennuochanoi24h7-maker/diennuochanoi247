...
export default function Home() {
    const slideItems = [
        ...
        },
        {
            ...
            label: "LẮP ĐẶT THIẾT BỊ ĐIỆN DÂN DỤNG",
        ...
        {
            href: '/',
            src: '/assets/services/dien/dien-9.jpg',
            label: "LẮP ĐẶT, THAY BÓNG ĐÈN, SỬA CHỮA ĐÈN SƯỞI NHÀ TẮM",
            description: "Chuyên cung cấp dịch vụ lắp đặt, thay bóng và sửa chữa đèn sưởi nhà tắm."
        },
        {
            href: '/',
    ...
    const bannerTitle = "<span>DỊCH VỤ SỬA CHỮA,</span> <span>LẮP ĐẶT ĐIỆN</span> <span>CHUYÊN NGHIỆP TẠI NHÀ</span> SỐ 1 HÀ NỘI"
    const introduce = "Điện Nước Hà Nội 247 chuyên tất cả các dịch vụ về điện: <strong>sửa chập điện, sửa chữa lắp đặt điện, các thiết bị điện, đi dây điện âm tường, lắp công tơ, đồng hồ điện,... tại nhà</strong>. Các cơ sở trải khắp trên toàn bộ TP Hà Nội. Với đội ngũ kỹ sư có <strong>chuyên môn cao hơn 10 năm kinh nghiệm</strong>, chúng tôi cam kết chất lượng cao, uy tín cho khách hàng. <strong>Lấy khách hàng là trọng tâm</strong> để phát triển sản phẩm, dịch vụ ngày một hoàn thiện, phát triển hơn."
