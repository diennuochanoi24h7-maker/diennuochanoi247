...
export default function Home() {
    const slideItems = [
        ...
        },
        {
            ...
            label: "LẮP ĐẶT BÌNH NÓNG LẠNH CHÍNH HÃNG THEO YÊU CẦU, TƯ VẤN MIỄN PHÍ",
        ...
        },
        {
            ...
            label: "BẢO DƯỠNG, VỆ SINH BÌNH NÓNG LẠNH",
        ...
        },
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG NĂNG LƯỢNG MẶT TRỜI",
        ...
        },
        {
            ...
            label: "SỮA CHỮA, LẮP ĐẶT MÁY LỌC NƯỚC TẤT CẢ CÁC HÃNG TẠI NHÀ",
        ...
        },
        {
            ...
            label: "SỬA CHỮA TỦ LẠNH TẤT CẢ CÁC HÃNG TẠI NHÀ",
    ...
    const bannerTitle = "<span>DỊCH VỤ SỬA CHỮA,</span> <span>LẮP ĐẶT BÌNH NÓNG LẠNH</span> <span>CHUYÊN NGHIỆP TẠI NHÀ</span> SỐ 1 HÀ NỘI"
    const introduce = "Điện Nước Hà Nội 247 chuyên tất cả các dịch vụ về bình nóng lạnh: <strong>sửa bình nóng lạnh rò nước, hỏng sợi đốt, không nóng, đun nóng lâu, chập cháy khét, lắp đặt, bảo dưỡng bình nóng lạnh,... tất cả các hãng tại nhà</strong>. Các cơ sở trải khắp trên toàn bộ TP Hà Nội. Với đội ngũ kỹ sư có <strong>chuyên môn cao hơn 10 năm kinh nghiệm</strong>, chúng tôi cam kết chất lượng cao, uy tín cho khách hàng. <strong>Lấy khách hàng là trọng tâm</strong> để phát triển sản phẩm, dịch vụ ngày một hoàn thiện, phát triển hơn."
