    ...
    const slideItems = [
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC BỊ CHẬP CHÁY TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC BỊ KÊU TO TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC LÊN YẾU TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC GIA ĐÌNH TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT MÁY BƠM ĐẨY, BƠM TĂNG ÁP CHÍNH HÃNG TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM RÒ RỈ NƯỚC, LẮP ĐẶT PHAO CHỐNG TRÀN TẠI BẮC TỪ LIÊM",
