    ...
    const slideItems = [
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC BỊ CHẬP CHÁY TẠI CẦU GIẤY",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC BỊ KÊU TO TẠI CẦU GIẤY",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC LÊN YẾU TẠI CẦU GIẤY",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM NƯỚC GIA ĐÌNH TẠI CẦU GIẤY",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT MÁY BƠM ĐẨY, BƠM TĂNG ÁP CHÍNH HÃNG TẠI CẦU GIẤY",
        ...
        },
        {
            ...
            label: "SỬA MÁY BƠM RÒ RỈ NƯỚC, LẮP ĐẶT PHAO CHỐNG TRÀN TẠI CẦU GIẤY",
