...
export default function Home() {
    const slideItems = [
        {
            ...
            label: "SỬA CHẬP ĐIỆN KHẨN CẤP TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "SỬA CHỮA, LẮP ĐẶT ĐIỆN TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT, SỬA CHỮA BÓNG ĐÈN, Ổ CẮM, CB, CẦU DAO… TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "ĐI DÂY ĐIỆN ÂM TƯỜNG TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "LẮP ĐỒNG HỒ KIỂM ĐỊNH 1P, 3P TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT THIẾT BỊ ĐIỆN DÂN DỤNG TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "SỬA CHỮA, LẮP ĐẶT BẾP TỪ, BẾP ĐIỆN TẠI NHÀ - HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "SỬA CHỮA TỦ LẠNH TẠI NHÀ - HAI BÀ TRƯNG",
    ...
    const bannerTitle = "SỬA ĐIỆN TẠI HAI BÀ TRƯNG"
    const introduce = "Điện Nước Hà Nội 247 chuyên tất cả các dịch vụ về điện tại Hai Bà Trưng: <strong>sửa chập điện, sửa chữa lắp đặt điện, các thiết bị điện, đi dây điện âm tường, lắp công tơ, đồng hồ điện,... tại nhà</strong>. Các cơ sở trải khắp trên toàn bộ TP Hà Nội. Với đội ngũ kỹ sư có <strong>chuyên môn cao hơn 10 năm kinh nghiệm</strong>, chúng tôi cam kết chất lượng cao, uy tín cho khách hàng. <strong>Lấy khách hàng là trọng tâm</strong> để phát triển sản phẩm, dịch vụ ngày một hoàn thiện, phát triển hơn."
