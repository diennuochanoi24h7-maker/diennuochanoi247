    ...
    const slideItems = [
        {
            ...
            label: "SỬA RÒ RỈ ỐNG NƯỚC, DÒ TÌM ỐNG NƯỚC TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "XỬ LÝ CHỐNG THẤM TƯỜNG, TRẦN, SÀN NHÀ TẠI HAI BÀ TRƯNG",
            description: "Chuyên xử lý chống thấm cho tường, trần, sàn nhà triệt để bảo hành dài hạn"
        },
        {
            href: '/',
            src: '/assets/services/nuoc/nuoc-4.jpg',
            label: "LẮP ĐẶT ĐƯỜNG ỐNG NƯỚC, THIẾT BỊ VỆ SINH TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT THIẾT BỊ VỆ SINH: BỒN CẦU, BỒN BỆT, LAVABO, VAN NƯỚC, VÒI NƯỚC,... TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "DỊCH VỤ SỬA CHỮA HỆ THỐNG NƯỚC TRONG SINH HOẠT TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "DỊCH VỤ VỆ SINH BỒN NƯỚC, BỂ NƯỚC TẠI HAI BÀ TRƯNG",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT ĐỒNG HỒ NƯỚC GIÁ TỐT TẠI HAI BÀ TRƯNG",
