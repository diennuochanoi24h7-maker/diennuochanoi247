    ...
    const slideItems = [
        {
            ...
            label: "SỬA RÒ RỈ ỐNG NƯỚC, DÒ TÌM ỐNG NƯỚC TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT THIẾT BỊ VỆ SINH: BỒN CẦU, BỒN BỆT, LAVABO, VAN NƯỚC, VÒI NƯỚC,... TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "DỊCH VỤ SỬA CHỮA HỆ THỐNG NƯỚC TRONG SINH HOẠT TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "DỊCH VỤ VỆ SINH BỒN NƯỚC, BỂ NƯỚC TẠI BẮC TỪ LIÊM",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT ĐỒNG HỒ NƯỚC GIÁ TỐT TẠI BẮC TỪ LIÊM",
