...
export default function Home() {
    const slideItems = [
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG RÒ NƯỚC TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG HỎNG SỢI ĐỐT TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG CÓ NƯỚC NÓNG KHÔNG RA TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG BÁO ĐÈN SÁNG NHƯNG KHÔNG ĐUN NÓNG TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG KHÔNG NÓNG, NÓNG KÉM, CHẬM NÓNG TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG CHẬP CHÁY, CÓ MÙI KHÉT TRONG BÌNH TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "LẮP ĐẶT BÌNH NÓNG LẠNH CHÍNH HÃNG THEO YÊU CẦU, TƯ VẤN MIỄN PHÍ TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "BẢO DƯỠNG, VỆ SINH BÌNH NÓNG LẠNH TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "SỬA BÌNH NƯỚC NÓNG NĂNG LƯỢNG MẶT TRỜI TẠI TÂY HỒ",
        ...
        },
        {
            ...
            label: "SỮA CHỮA, LẮP ĐẶT MÁY LỌC NƯỚC TẤT CẢ CÁC HÃNG TẠI TÂY HỒ",
    ...
    const bannerTitle = "<span>DỊCH VỤ SỬA CHỮA,</span> <span>LẮP ĐẶT BÌNH NÓNG LẠNH </span> <span>TẠI TÂY HỒ</span>"
    const introduce = "Điện Nước Hà Nội 247 chuyên tất cả các dịch vụ về bình nóng lạnh tại Tây Hồ: <strong>sửa bình nóng lạnh rò nước, hỏng sợi đốt, không nóng, đun nóng lâu, chập cháy khét, lắp đặt, bảo dưỡng bình nóng lạnh,... tất cả các hãng tại nhà</strong>. Các cơ sở trải khắp trên toàn bộ TP Hà Nội. Với đội ngũ kỹ sư có <strong>chuyên môn cao hơn 10 năm kinh nghiệm</strong>, chúng tôi cam kết chất lượng cao, uy tín cho khách hàng. <strong>Lấy khách hàng là trọng tâm</strong> để phát triển sản phẩm, dịch vụ ngày một hoàn thiện, phát triển hơn."
