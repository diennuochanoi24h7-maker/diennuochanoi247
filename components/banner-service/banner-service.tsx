...
const BannerService: React.FC<BannerServicesProps> = ({title = "", imgBanner}) => {
    return (
        <section id="banner" className="banner-services-container">
            <div className="background-video-container">
                <img className="img-banner" src={imgBanner} alt="anh banner"/>
            </div>
            {/* <div className="img-event-1">
                <img className="img-event-banner" src="/assets/event/event_29.png" alt="image event"/>
            </div> */}
            <div className='background-overlay'></div>
            <div className="elementor-container elementor-column-gap-no banner-services-container-info">
                        ...
                        <section className="elementor-section-banner">
                            <div className="wdt-heading-holder pb-6">
                                <div className="wdt-heading-subtitle-wrapper wdt-heading-align-1 "><span
                                    className="wdt-heading-subtitle"><span>Điện Nước Hà Nội 247</span> - <span className="slogan">&quot;TRAO CHỮ TÍN - TRỌN NIỀM TIN&quot;</span></span></div>
                                ...
                                <div className="info-item">
                                    ...
                                    <div className="services-banner">
                                        <ul className="services-list commitment-list">
                                            <li><i className="icon-check fa-solid fa-circle-check"></i> Sửa Chữa Uy Tín
                                                Chất Lượng
                                            </li>
                                            <li><i className="icon-check fa-solid fa-circle-check"></i> Khắc Phục Tận
                                                Gốc
                                            </li>
                                            <li><i className="icon-check fa-solid fa-circle-check"></i> Đúng Giá</li>
                                            <li><i className="icon-check fa-solid fa-circle-check"></i> Dịch Vụ Trọn Gói
                                            </li>
                                            <li><i className="icon-check fa-solid fa-circle-check"></i> Bảo Hành Dài Hạn
                                            </li>
                                            <li><i className="icon-check fa-solid fa-circle-check"></i> Tư Vấn Miễn Phí
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className="click-now">
                                        ...
                                        <div className="elementor-widget-container">
                                            <div
                                                className="wdt-button-holder wdt-template-filled wdt-button-link wdt-button-style-default wdt-button-size-nm wdt-animation- wdt-button-icon-after">
                                                <a className="wdt-button button-white" href="#service-list"
